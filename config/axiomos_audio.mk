...
ALARM_PATH := vendor/axiomos/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/axiomos/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/axiomos/prebuilt/common/media/audio/ringtones
